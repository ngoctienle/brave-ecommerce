        ...
        <div className='flex items-center justify-end gap-3'>
            ...
            <Popover
              ...
              renderPopover={
                <div className='flex flex-col rounded-16 bg-white p-3 shadow-lg'>
                  <Link
                    className='fs-16 rounded-8 py-3 px-6 text-left text-primary-1A162E transition-colors hover:bg-secondary-F8F8FB/60 hover:text-secondary-77DAE6'
                    to={paths.profile}>
                    Tài khoản của tôi
                  </Link>
                  <Link
          ...
          {!isAuthenticated && (
            <div className='flex items-center gap-1'>
              <Link
                to={paths.register}
                className='fs-14 whitespace-nowrap rounded-8 border border-transparent py-[6px] px-2 text-center capitalize text-primary-1A162E transition-colors hover:text-primary-1A162E/70'>
                Đăng kí
              </Link>
              {/* <div className='h-4 border-r-[1px] border-r-primary-1A162E'></div> */}
              <Link
                to={paths.login}
                className='fs-14 whitespace-nowrap rounded-8 border border-primary-1A162E py-[6px] px-2 text-center capitalize text-primary-1A162E transition-colors hover:border-primary-1A162E/70 hover:text-primary-1A162E/70'>
                Đăng nhập
              </Link>
            </div>
          )}
          ...
          <Popover
            ...
            renderPopover={
              <div className='flex flex-col rounded-16 bg-white p-3 shadow-lg'>
                <button className='fs-16 rounded-8 py-3 px-6 text-primary-1A162E transition-colors hover:bg-secondary-F8F8FB/60 hover:text-secondary-77DAE6'>
                  Tiếng Việt
                </button>
                <button className='fs-16 mt-1 rounded-8 py-3 px-6 text-primary-1A162E transition-colors hover:bg-secondary-F8F8FB/60 hover:text-secondary-77DAE6'>
                  Tiếng Anh
                </button>
              </div>
            }>
              ...
              renderPopover={
                <div className='flex w-[400px] flex-col rounded-16 bg-white p-3 shadow-lg'>
                  <div className='flex items-center justify-between'>
                    <span className='fs-16 font-semibold capitalize text-primary-1A162E'>
                      Sản phẩm mới thêm
                    </span>
                    <Link
                      to={paths.cart}
                    ...
                    ? purchaseListInCart.slice(0, MAX_PRODUCT).map((purchase) => (
                        <div
                          ...
                          <div className='flex-grow overflow-hidden'>
                            <p className='fs-16 truncate text-primary-1A162E'>
